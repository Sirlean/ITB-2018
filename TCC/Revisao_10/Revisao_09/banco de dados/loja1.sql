...
insert into tb_produto (tipo,nome,genero,quantidade,preco, fabricante, plataforma, faixa_etaria, condicao, fornecedor)
		...
		values   ( 'JOGOS', 'DRAGON BALL FIGHTERZ EDIÇÃO FIGHTERZ','LUTA VS 3', 20, 174.90,'BANDAI NAMCO','PLAYSTATION 4','12 ANOS','NOVO','SONY'),
				 ...
				 ( 'CONSOLE', 'CONSOLE PS4 500GB SLIM + UNCHARTED','OUTROS', 20, 1599.90, 'SONY','PLAYSTATION 4','LIVRE','NOVO','SONY' ),
				...
				---(tipo,nome,genero,quantidade,preco, fabricante, plataforma, faixa_etaria, condicao, fornecedor)
					...
					('CONTROLE','CONTROLE PS3 FEIR S/ FIO','OUTROS',12,129.90,'SONY','PLAYSTATION 3','LIVRE','NOVO','SONY'),
...
(cd_cpf int identity (1,1) primary key,
...
insert into tb_cliente (Nome, Cpf, Rg, Genero, Endereco, Numero, Cidade, Cep, Estado, UF, Email, telefone, Celular, Cliente_fornecedor)
	
	---clientes cadastrados
	values	('Lucas Santos', '011.000.222-52', 12345-3,'M','Rua Guimaraes Rosa', 07, 'Barueri',06435-000, 'São Paulo', 'SP', 'lucas@gmail.com',41255595, 994993256, 'S'),
			('Alberto Souza', '01.222.333-67', 235412-5,'M', 'Via Carijo', 13,'Barueri', 06453200, 'São Paulo', 'SP', 'alberto@hotmail.com',41948855,  72628558, 'S'),
			('Guilherme Matias', '002.336.212-25',123564-9,'M','Rua Mathias', 01, 'Jandira', 06352000, 'São Paulo', 'SP', 'guilherme@gmail.com', 42154254,  74853214,'N'),
			('Felipe Santiago', '002.336.212-23',129064-9,'M','Rua Antonio', 01, 'Osasco', 06352000, 'São Paulo', 'SP', 'felipe@gmail.com', 35154254,  74853213,'N');
